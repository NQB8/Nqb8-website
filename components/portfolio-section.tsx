...
export default async function PortfolioSection() {
  ...
  return (
    <section className="relative z-20 py-24 px-8 bg-[#080808] border-t border-white/5 scroll-mt-24" id="portfolio">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              key={project.title}
              className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-colors duration-300"
            >
